...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_6x4_9(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,
                             KC_F18, KC_Q, KC_W, KC_F, KC_P, KC_B,
                             KC_NO, MT(MOD_LGUI,KC_A), MT(MOD_LALT,KC_R), MT(MOD_LCTL,KC_S), KC_T, KC_D,
                             KC_NO, KC_Z, KC_X, KC_C, KC_G, KC_V,
                                                                         KC_NO, KC_NO, KC_NO,
                             KC_NO, MT(MOD_LSFT,KC_TAB), LT(1,KC_SPC), KC_NO, KC_NO, KC_NO,

                                                                                                                              KC_F7, KC_F8, KC_F9, KC_F10, KC_F12, KC_NO,
                                                                                                                              KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_PSCR,
                                                                                                                              KC_H, KC_N, MT(MOD_RCTL, KC_E), MT(MOD_RALT, KC_I), MT(MOD_RGUI, KC_O), KC_NO,
	...
	[2] = LAYOUT_split_6x4_9(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                             ...
                             KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MUTE,
